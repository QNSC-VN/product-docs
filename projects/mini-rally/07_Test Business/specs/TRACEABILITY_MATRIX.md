...
| Module | Source | Key business requirement | Test coverage | Out-of-scope / note |
|---|---|---|---|---|
| Manage Projects + Settings Teams/Users | `Phase 1/08_Manage_Projects_Teams_Users/SRS.md` | Manage Projects contains Projects only; Settings gear contains Team create/edit and User Management/team membership access | `P1-MANAGE-*`, `E2E-002` | Team capacity/velocity fields are not in Phase 1 create/edit. |
...
| Out-of-scope Project Admin enforcement | `E2E-009` | Confirms UI gating plus backend permission enforcement. |
...
| Phase 4 | Notifications, Roles & Permissions, Workspace/User Settings, Audit | Test users for each approved role and accessible/inaccessible notification targets. |
