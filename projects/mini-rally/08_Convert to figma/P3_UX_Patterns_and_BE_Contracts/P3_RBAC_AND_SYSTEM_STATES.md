...
| (No Access) | Implicit — no `project_members` row. Project is hidden and direct access rejected |
...
Disabled is not an assignable access level. It must not be used as a replacement for No Access (a hidden project).
...
Normal users may show a contextual Admin/Editor badge in the selected Project header. Do not present it as one global account role.

## Project Structure Gating

| Surface / action | WA | Admin | Editor |
|---|---:|---:|---:|
| View assigned Project Details/Teams | Allowed | Read-only | Read-only, scoped |
| View Project Users & Permissions | Allowed | Read-only | Hidden |
| Create/Edit/Archive/Delete Project | Allowed | Hidden | Hidden |
| Add/Edit/Deactivate/Restore Team | Allowed | Hidden | Hidden |
| Add/change/remove Project user | Allowed | Hidden | Hidden |

## Pilot Surface Gating - Backlog And Work Item Detail

| Surface / action | WA | Admin | Editor |
|---|---:|---:|---:|
| View rows, search, filter, sort and detail | Allowed | Allowed | Allowed in assigned Teams |
| Create US/DE | Allowed | Allowed | Allowed in assigned Teams |
| Edit fields, notes, relations and rank | Allowed | Allowed | Allowed in assigned Teams |
| Create/Edit/Delete child Task | Allowed | Allowed | Allowed in assigned Teams |
| Delete US/DE/Task | Allowed | Allowed | Allowed in assigned Teams |
| Assign to Iteration | Allowed | Allowed | Allowed in assigned Teams |
| Assign to Release | Allowed | Allowed | Hidden |
...
- A user with no Project row (No Access) has no Project Access entry and no Team controls.
